...
export declare const expressMiddleware: (hostObj: DecoratedInstance, config?: Partial<IConfig>) => (req: IExpressRequest, res: unknown, next: (...args: unknown[]) => unknown) => void;
export {};
